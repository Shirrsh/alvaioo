...
import { NavLink, LucideIconType } from './types'; // Added LucideIconType
import {
    Home, Briefcase, Cpu, BarChart2, Users, MessageSquare, Info, FileText, LogIn, ShoppingCart, Settings, Zap, ListChecks, Bot, Mail, Send, Filter, Users2, Building, Palette, Gem, ZapIcon, TrendingUp, ShieldCheck, PhoneCall, BrainCircuit, Workflow, MailCheck, MessageCircle, BarChartBig
...
export const LOTTIE_ANIMATIONS = {
  hero: 'https://assets10.lottiefiles.com/packages/lf20_LW9L229L2V.json', // Abstract tech/plexus
  ecommerceAiMerge: 'https://assets3.lottiefiles.com/packages/lf20_xnsda3nb.json', // Abstract data/AI
  chatbot: 'https://assets3.lottiefiles.com/packages/lf20_UW9K24.json',
  workflowArrows: 'https://assets8.lottiefiles.com/packages/lf20_i2wz9j5t.json', // Growing arrows
  ...
  robotAssistant: 'https://assets4.lottiefiles.com/packages/lf20_aZTdD5.json', // Friendly robot
  automationPipes: 'https://assets9.lottiefiles.com/packages/lf20_nxsyeffk.json',
  customerMessaging: 'https://assets2.lottiefiles.com/packages/lf20_gjmecwer.json', // Chat bubbles
  timelineFlow: 'https://assets1.lottiefiles.com/packages/lf20_cUG5wO.json' // Path animation
};
...
// SOCIAL_HANDLES doesn't store icons directly here, Footer.tsx maps them
