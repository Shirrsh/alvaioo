...
import { NAV_LINKS } from '@/constants'; // LOTTIE_ANIMATIONS no longer needed here
import { Star, TrendingUp } from 'lucide-react'; // MessageSquare not used
// import LottiePlayer from '@/components/LottiePlayer'; // Not used directly
...
const CaseStudiesPage: React.FC = () => {
  return (
    ...
    <SectionWrapper id="case-studies-3d" bgClassName="py-10 md:py-12 bg-light-bg dark:bg-dark-bg">
        <Suspense fallback={<div className="suspense-fallback">Loading 3D Scene...</div>}>
          <Minimal3DScene meshShape="box" meshColor="#F0ABFC" cameraPosition={[0,0,4]} wireframe={true} />
        </Suspense>
    </SectionWrapper>
    ...
    <SectionWrapper id="testimonials" bgClassName="py-16 md:py-24 bg-light-bg dark:bg-dark-bg">
      ...
      <div className="mt-16 text-center">
        <ScrollReveal>
            ...
            <Link
                to={NAV_LINKS['contact-us']} 
                className="bg-brand-primary hover:bg-brand-primary/90 text-white font-semibold py-3 px-6 rounded-lg shadow-md transition-colors"
            >
