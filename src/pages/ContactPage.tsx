...
import { COMPANY_INFO, CONTACT_FORM_FIELDS, SOCIAL_HANDLES, NAV_LINKS } from '@/constants';
import { Mail, Phone, MapPin, Send, Linkedin, Twitter, Facebook, CheckCircle, ArrowRight } from 'lucide-react';
    ...
    <SectionWrapper id="contact" bgClassName="py-20 md:py-28 bg-light-bg dark:bg-dark-bg">
      ...
      <div className="mb-12">
        <Suspense fallback={<div className="suspense-fallback">Loading 3D Scene...</div>}>
          <Minimal3DScene meshShape="sphere" meshColor="#6366F1" enableControls={false} cameraPosition={[0,0,3]}/>
        </Suspense>
      </div>
